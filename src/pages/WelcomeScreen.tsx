      ...
      <div className="welcome-content">
        <div className="welcome-logo">
          <svg width="88" height="88" viewBox="0 0 88 88" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M24 44C24 32.954 32.954 24 44 24C55.046 24 64 32.954 64 44C64 55.046 55.046 64 44 64" stroke="white" strokeWidth="4" strokeLinecap="round"/>
            <path d="M44 64C44 64 52 56 52 48C52 40 44 36 44 36" stroke="white" strokeWidth="4" strokeLinecap="round"/>
