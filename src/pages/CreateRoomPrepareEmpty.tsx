      ...
      <section className="crpe-share-bar">
        ...
        <div className="crpe-share-actions">
          ...
          <button className="crpe-share-btn" aria-label="Copy">
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
              <path d="M10.994 124.093C9.987 124.093 9 123.84 8.114 123.36C7.96 123.273 7.767 123.267 7.587 123.333L5.7 124.1C5.38 124.24 5.02 124.02 5.02 123.673V119.327C5.02 119.127 5.147 118.947 5.333 118.867L7.587 117.907C7.767 117.827 7.96 117.833 8.114 117.92C9 118.4 9.987 118.653 10.994 118.653C12.001 118.653 12.988 118.4 13.874 117.92C14.028 117.833 14.221 117.827 14.401 117.907L16.655 118.867C16.841 118.947 16.968 119.127 16.968 119.327V123.673C16.968 124.02 16.608 124.24 16.288 124.1L14.401 123.333C14.221 123.267 14.028 123.273 13.874 123.36C12.988 123.84 12.001 124.093 10.994 124.093ZM6.02 120.367V122.593L7.34 122.047C7.867 121.82 8.454 121.82 8.981 122.047C9.627 122.32 10.294 122.46 10.994 122.46C11.694 122.46 12.361 122.32 13.007 122.047C13.534 121.82 14.121 121.82 14.648 122.047L15.968 122.593V120.367L14.648 119.82C14.121 119.593 13.534 119.593 13.007 119.82C12.361 120.093 11.694 120.233 10.994 120.233C10.294 120.233 9.627 120.093 8.981 119.82C8.454 119.593 7.867 119.593 7.34 119.82L6.02 120.367Z" fill="white" transform="translate(-5 -117)" />
            </svg>
          </button>
        </div>
      </section>
