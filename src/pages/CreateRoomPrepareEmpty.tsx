...
function RoomPersonIcon({ size = 24 }: { size?: number }) {
  return (
...
/** White disc with a red X — used for the close affordance on the red header. */
function CloseCircleWhiteIcon() {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" aria-hidden="true">
      <circle cx="12" cy="12" r="10" fill="var(--color-white)" />
      <path
