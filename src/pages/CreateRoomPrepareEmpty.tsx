    ...
    <div className="crpe-shell">
      ...
      <header className="crpe-header">
        ...
        <button className="crpe-header-btn" aria-label="Close" onClick={() => navigate('/')}>
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
            <circle cx="12" cy="12" r="10" fill="white" />
            <path d="M16.21 9.41C15.88 9.11 15.38 9.13 15.08 9.46L12 12.82L8.92 9.46C8.62 9.13 8.11 9.11 7.79 9.41C7.46 9.71 7.44 10.21 7.74 10.54L10.91 14L7.74 17.46C7.44 17.79 7.46 18.29 7.79 18.59C7.94 18.73 8.14 18.8 8.33 18.8C8.55 18.8 8.76 18.71 8.92 18.54L12 15.18L15.08 18.54C15.24 18.71 15.45 18.8 15.67 18.8C15.86 18.8 16.06 18.73 16.21 18.59C16.54 18.29 16.56 17.79 16.26 17.46L13.09 14L16.26 10.54C16.56 10.21 16.54 9.71 16.21 9.41Z" fill="white" />
          </svg>
        </button>
      </header>
        ...
        <div className="crpe-friends-empty">
          <div className="crpe-friends-illustration">
            <svg width="96" height="96" viewBox="0 0 96 96" fill="none">
              <path d="M23.691 70.855V44.513L45.481 54.681L76 47.127V69.486L45.481 81.024L23.691 70.855Z" fill="#FF6678" />
              <path d="M23.691 44.513V70.855L45.481 81.024V54.681L23.691 44.513Z" fill="#FF5769" />
              <path d="M23.692 44.513C23.692 44.513 17.106 49.259 14.977 55.845L37.058 67.08C37.058 67.08 41.804 58.365 45.483 54.683L23.694 44.515L23.692 44.513Z" fill="#FF7587" />
              <path d="M76 47.127L45.481 54.681C49.839 60.878 49.839 68.434 49.839 68.434L81.022 58.944C80.44 53.715 76 47.13 76 47.13L76 47.127Z" fill="#FF7587" />
              <path d="M23.691 44.513L48.291 39.38L76 47.127L45.481 54.681L23.691 44.513Z" fill="#CC5260" />
              ...
              <path d="M48.291 39.38L23.691 44.513L45.481 54.681L48.291 53.988V39.38Z" fill="#C54956" />
            </svg>
          </div>
