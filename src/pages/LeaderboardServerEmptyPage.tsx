...
function EmptyGiftIllustration() {
  return (
    <svg width="96" height="96" viewBox="0 0 96 96" fill="none">
      {/* Gift box base */}
      <path d="M24 66.855V40.513L45.79 50.681L76.297 43.127V65.486L45.79 77.024L24 66.855Z" fill="#FF6678"/>
      <path d="M24 40.513V66.855L45.79 77.024V50.681L24 40.513Z" fill="#FF5769"/>
      <path d="M24 40.513C24 40.513 17.414 45.259 15.285 51.845L37.366 63.08C37.366 63.08 42.112 54.365 45.791 50.683L24.002 40.515L24 40.513Z" fill="#FF7587"/>
      <path d="M76.297 43.127L45.79 50.681C50.148 56.878 50.148 64.434 50.148 64.434L81.331 54.944C80.749 49.715 76.295 43.13 76.295 43.13L76.297 43.127Z" fill="#FF7587"/>
      <path d="M24 40.513L48.6 35.381L76.297 43.127L45.79 50.681L24 40.513Z" fill="#CC5260"/>
      {/* Gift ribbons */}
      <path d="M44.641 32.281L37.669 18.337L34.763 25.309L44.641 32.281Z" fill="#FF7587"/>
      <path d="M48.709 28.988V10.976L53.358 16.399L48.709 28.988Z" fill="#FF7587"/>
      <path d="M52.195 32.281L58.395 21.63L59.749 28.02L52.195 32.281Z" fill="#FF7587"/>
      <path d="M48.6 35.381L24 40.513L45.79 50.681L48.6 49.988V35.381Z" fill="#C54956"/>
      {/* Decorative sparkles */}
      <path d="M47.57 46.646L47.389 46.307C47.548 46.224 47.703 46.125 47.851 46.013L48.081 46.322C47.917 46.442 47.746 46.552 47.57 46.646Z" fill="#FF6678"/>
      <path d="M71.499 24.68C71.71 24.833 71.759 25.127 71.607 25.337C71.454 25.548 71.04 25.762 70.83 25.612C70.619 25.462 70.69 24.998 70.842 24.788C70.995 24.577 71.289 24.528 71.499 24.68Z" fill="#FF6678"/>
      <path d="M71.84 24.206C72.051 24.358 72.072 24.691 71.886 24.951C71.699 25.21 71.229 25.502 71.018 25.35C70.808 25.198 70.935 24.661 71.121 24.401C71.308 24.142 71.63 24.056 71.84 24.206Z" fill="#FF6678"/>
      <path d="M71.465 24.73C71.465 24.73 71.515 23.753 70.583 24.094C69.651 24.436 69.555 25.378 71.124 25.206L71.467 24.73H71.465Z" fill="#FF6678"/>
      <path d="M71.466 24.73C71.466 24.73 72.376 24.371 72.348 25.365C72.32 26.359 71.457 26.75 71.122 25.206L71.466 24.73Z" fill="#FF6678"/>
    </svg>
  );
}
