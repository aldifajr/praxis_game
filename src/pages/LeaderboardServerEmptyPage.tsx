...
function EmptyGiftIllustration() {
  return (
    <svg width="96" height="96" viewBox="0 0 96 96" fill="none">
      ...
      {/* Decorative sparkles */}
      <path
        d="M47.57 46.646L47.389 46.307C47.548 46.224 47.703 46.125 47.851 46.013L48.081 46.322C47.917 46.442 47.746 46.552 47.57 46.646Z"
        fill="#FF6678"
      />
      <path
        d="M71.499 24.68C71.71 24.833 71.759 25.127 71.607 25.337C71.454 25.548 71.04 25.762 70.83 25.612C70.619 25.462 70.69 24.998 70.842 24.788C70.995 24.577 71.289 24.528 71.499 24.68Z"
        fill="#FF6678"
      />
      <path
        d="M71.84 24.206C72.051 24.358 72.072 24.691 71.886 24.951C71.699 25.21 71.229 25.502 71.018 25.35C70.808 25.198 70.935 24.661 71.121 24.401C71.308 24.142 71.63 24.056 71.84 24.206Z"
        fill="#FF6678"
      />
      <path
        d="M71.465 24.73C71.465 24.73 71.515 23.753 70.583 24.094C69.651 24.436 69.555 25.378 71.124 25.206L71.467 24.73H71.465Z"
        fill="#FF6678"
      />
      <path
        d="M71.466 24.73C71.466 24.73 72.376 24.371 72.348 25.365C72.32 26.359 71.457 26.75 71.122 25.206L71.466 24.73Z"
        fill="#FF6678"
      />
    </svg>
  );
