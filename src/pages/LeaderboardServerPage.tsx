...
function CloseIcon() {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
      <path d="M498.21 9.41C497.88 9.11 497.38 9.13 497.08 9.46L494 12.82L490.92 9.46C490.62 9.13 490.11 9.11 489.79 9.41C489.46 9.71 489.44 10.21 489.74 10.54L492.91 14L489.74 17.46C489.44 17.79 489.46 18.29 489.79 18.59C489.94 18.73 490.14 18.8 490.33 18.8C490.55 18.8 490.76 18.71 490.92 18.54L494 15.18L497.08 18.54C497.24 18.71 497.45 18.8 497.67 18.8C497.86 18.8 498.06 18.73 498.21 18.59C498.54 18.29 498.56 17.79 498.26 17.46L495.09 14L498.26 10.54C498.56 10.21 498.54 9.71 498.21 9.41Z" fill="white" transform="translate(-482 -2)"/>
      <path d="M494 4C488.49 4 484 8.49 484 14C484 19.51 488.49 24 494 24C499.51 24 504 19.51 504 14C504 8.49 499.51 4 494 4ZM494 22.4C489.37 22.4 485.6 18.63 485.6 14C485.6 9.37 489.37 5.6 494 5.6C498.63 5.6 502.4 9.37 502.4 14C502.4 18.63 498.63 22.4 494 22.4Z" fill="white" transform="translate(-482 -2)"/>
    </svg>
  );
}
...
function SocialIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
      <path d="M8 1C4.13 1 1 4.13 1 8C1 11.87 4.13 15 8 15C11.87 15 15 11.87 15 8C15 4.13 11.87 1 8 1ZM11.5 5.5C11.5 5.78 11.28 6 11 6C10.72 6 10.5 5.78 10.5 5.5C10.5 5.22 10.72 5 11 5C11.28 5 11.5 5.22 11.5 5.5ZM8 11.5C6.62 11.5 5.5 10.38 5.5 9C5.5 7.62 6.62 6.5 8 6.5C9.38 6.5 10.5 7.62 10.5 9C10.5 10.38 9.38 11.5 8 11.5Z" fill="#2B2B2B"/>
    </svg>
  );
}
